...
class FetchorderScreen extends StatefulWidget {
  @override
  _FetchorderScreenState createState() => _FetchorderScreenState();
}
class _FetchorderScreenState extends State<FetchorderScreen> {
  ...
  Future<void> fetchData() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          orders = body.cast<Map<String, dynamic>>();
        });
      } else {
